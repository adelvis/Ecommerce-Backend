     ...
     <div class="modal-content">
      ...
      <!--  <form role="form" method="post" enctype="multipart/form-data"> -->
            ...
            <div class="modal-body">
              ...
              <div class="box-body">
                    ...
                    <div class="form-group">
                     ...
                     <!--=====================================
                    ENTRADA PARA EL TIPO DEL PRODUCTO
                    ======================================-->
                    ...
                    <div class="form-group agregarMultimedia"> 
                     ...
                     <!--=====================================
                    ENTRADA PARA AGREGAR DETALLES VIRTUALES
                    ======================================-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control input-lg seleccionarCategoria">
                            ...
                            $categories = ControllerCategories::ctrViewCategories($item, $valor);
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary guardarProducto" >Guardar productos</button>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control input-lg seleccionarCategoria">
                              ...
                              $categorias = ControllerCategories::ctrViewCategories($item, $valor);
