    ...
    <section class="content">
      ...
      <div class="box">
          ...
          <div class="box-body">
              ...
              <table class="table table-bordered table-striped tablaBanner dt-responsive" width="100%">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
        ...
        $crearBanner = new ControllerBanner();
        $crearBanner -> ctrCreateBanner();
    ...
    <div class="modal-content">
         ...
         <form method="post" enctype="multipart/form-data">
          ...
          <?php
            ...
            $editarBanner = new ControllerBanner();
            $editarBanner -> ctrEditBanner();
...
<?php
  ...
  $deleteBanner = new ControllerBanner();
  $deleteBanner -> ctrDeleteBanner();
