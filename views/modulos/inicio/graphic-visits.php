...
<?php
	...
	$countries = ControllerVisits::ctrViewCountries("quantity");
      			...
      			for ($i=0; $i < 4; $i++) { 
      				...
      				echo '
						...
						<div class="col-md-3 col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
							...
							<input type="text" class="knob" data-readonly="true" value="'.round($countries[$i]["quantity"]*100/$totalVisits["total"]).'" data-width="60" data-height="60"
							data-fgColor="#39CCCC">
