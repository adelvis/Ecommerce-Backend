...
$(".agregarSlide").click(function(event) {
	/* Act on the event */

	var imgBack= "views/img/slide/default/fondo.jpg";

	var typeSlide ="slideOpcion1";


	var styleTextSlide = '{"top": "20" ,"right": "" ,"left":"15", "width": "40"}';

	var title1 = '{"texto": "Lorem Ipsum" ,"color": "#333"}';

	var title2 = '{"texto": "Lorem ipsum dolor sit" ,"color": "#777"}';

	var title3 = '{"texto": "Lorem ipsum dolor sit" ,"color": "#888"}';

	var button = 'VER PRODUCTOS';
	...
	.done(function() {
		...
		swal({
		      ...
		      text: "¡El Slide ha sido agregado correctamente!",
		      type: "success",
...
/*=====================================
= CAMBIA LA POSICIÒN DE UN SLIDE        =
=====================================*/
 // jQuery UI sortable for the todo list

var itemSlider = $(".itemSlide");
...
/*=====================================
= ACTUALIZAR NOMBRE DEL SLIDE        =
=====================================*/

$(".nombreSlide").change(function(event) {
	/* Act on the event */
...
for(var i = 0; i < tipoSlide.length; i++){
	...
	$("input[name='tipoSlide"+i+"']").on("ifChecked",function(){
		...
		console.log('Línea 194. anchoSlide => ', anchoSlide);



		if(tipoSlide =="slideOpcion1"){

			//AGREGAR EN LA CLASE LA OPCION CORRESPONDIENTE
			$(slideOpciones[indiceSlide]).removeClass("slideOpcion2");
			$(slideOpciones[indiceSlide]).addClass(tipoSlide);
			...
			//AGREGAR EN LA CLASE LA OPCION CORRESPONDIENTE
			$(slideOpciones[indiceSlide]).removeClass("slideOpcion1");
			$(slideOpciones[indiceSlide]).addClass(tipoSlide);
...
/*=============================================
CAMBIO DE FONDO DEL SLIDE
=============================================*/
$(".subirFondo").change(function(event) {
	/* Act on the event */
...
=============================================*/
$(".subirImgProducto").change(function(event) {
	/* Act on the event */
...
/*=============================================
CAMBIO DE TEXTO Y COLOR DE LOS TITULOS 
=============================================*/
...
$(".cambioTituloTexto1").change(function(event) {
	...
	var texto1 = $(this).val();
	console.log('Línea 404. texto1 => ', texto1);
...
$(".cambioColorTexto1").change(function(event) {
...
$(".cambioTituloTexto2").change(function(event) {
...
$(".cambioColorTexto2").change(function(event) {
...
$(".cambioTituloTexto3").change(function(event) {
...
$(".cambioColorTexto3").change(function(event) {
...
for (var i = 0; i < slideOpciones.length; i++) {
		...
		/*=============================================
		CAMBIAR POSICIÓN DEL TEXTO SLIDE
		=============================================*/
		// Vertical
		...
		var anchoTexto = new Slider('.anchoTexto'+i, {
...
= GUARDAR SLIDE        =
=====================================*/
$(".guardarSlide").click(function(event) {
	...
	//Capturamos la imagen del slide
	...
	// subir fondo del slide

	datos.append('imgBack', imgFondo);

	if(subirFondo!= null){


		datos.append('fileBack', subirFondo[indiceSlide].files[0]);

	}else{

		datos.append('fileBack', subirFondo);

	}

	// subir imagen del producto del slide
	...
	if(subirImgProducto!= null){
		...
		datos.append('fileImgProduct', subirImgProducto[indiceSlide].files[0]);

	}else{

		datos.append('fileImgProduct', subirImgProducto);

	}

	// subir cambio titulo 1

	datos.append('title1', JSON.stringify(titulo1));

	// subir cambio titulo 2

	datos.append('title2', JSON.stringify(titulo2));

	// subir cambio titulo 3
	...
	.done(function(resp) {
		console.log('Línea 314. resp => ', resp);
		console.log("success");
		
		swal({
		      title: "Cambios guardados",
		      text: "¡El Slide ha sido cambiado correctamente!",
		      type: "success",
		      showConfirmButton: true,
		      confirmButtonText: "¡Cerrar!"
		    }).then((result)=>{
...
$(".eliminarSlide").click(function(){
	...
	swal({
        ...
        if (result.value) {
        	...
        	window.location = "index.php?ruta=slider&idSlide="+idSlide+"&imgFondo="+imgFondo+"&imgProducto="+imgProducto;
