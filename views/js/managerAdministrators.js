...
$(".tablaPerfiles tbody").on("click", ".btnActivar", function(){
...
$("#editarPassword1").change(function(event) {

  /* Act on the event */

  if ($("#editarPassword1").val() !=""){

        $("#editarPassword").val( $("#editarPassword1").val());
...
$(".tablaPerfiles").on("click", ".btnEliminarPerfil", function(){
  ...
  swal({
    ...
    if(result.value){
      ...
      window.location = "index.php?ruta=profiles&idPerfil="+idPerfil+"&fotoPerfil="+fotoPerfil;
